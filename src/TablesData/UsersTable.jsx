...
const UsersTable = () => {
 ...
 const usersTypography="Users Detail Fetched From API"
  return (
    <>
      
      <Table rows={data} columns={columns} handleVisibilityClick={handleVisibilityClick} tableHeading={usersTypography} />
      {selectedUser && (
        <ModalForm
  open={isModalOpen}
  ...
  userData={selectedUser} // Pass selectedUser as userData prop
  ch={commentsHeadings}
  uh={usersHeadings}
/>
